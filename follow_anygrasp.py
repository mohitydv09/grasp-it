...
from anygrasp_sdk.grasp_tracking.anygrasp_detector import AnyGrasp
...
robot = RobotController(lightning_ip="192.168.0.102", need_gripper=False,need_control=False)
...
anygrasp = AnyGrasp()
anygrasp.set_eff_pose(robot.get_eff_pose())
grasp = anygrasp.get_grasp()
print(grasp)

# while True:
#     grasp = anygrasp.get_grasp(robot.get_eff_pose())
#     print(grasp)
...
# input("Press Enter to Start Following Object")
