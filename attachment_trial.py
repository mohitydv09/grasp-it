...
def main(
    ...
    **kwargs,
    ...
    (vamp_module, planner_func, plan_settings,
     simp_settings) = vamp.configure_robot_and_planner_with_kwargs("ur5", planner, **kwargs)
    ...
    robot_dir = "vamp/resources/ur5"
    sim = vpb.PyBulletSimulator("vamp/resources/ur5/ur5_spherized.urdf", vamp.ROBOT_JOINTS['ur5'], True)
